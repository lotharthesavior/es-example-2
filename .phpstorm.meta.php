...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/savior/code/studies/es-visible/public/storage' => 'string',
...
'event-sourcing.auto_discover_projectors_and_reactors','event-sourcing.auto_discover_base_path','event-sourcing.projectors','event-sourcing.reactors','event-sourcing.queue',
'event-sourcing.catch_exceptions','event-sourcing.stored_event_model','event-sourcing.stored_event_repository','event-sourcing.snapshot_repository','event-sourcing.snapshot_model',
'event-sourcing.stored_event_job','event-sourcing.enforce_event_class_map','event-sourcing.event_class_map','event-sourcing.event_serializer','event-sourcing.event_normalizers',
'event-sourcing.cache_path','event-sourcing.dispatch_events_from_aggregate_roots','event-sourcing.aggregate_event_order_column','filesystems.default','filesystems.disks.local.driver',
...
'filesystems.links./home/savior/code/studies/es-visible/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace','logging.channels.stack.driver',
...
'dashboard.stats','demo.add-to-cart','demo.remove-from-cart','demo.checkout','demo.mark-as-paid',
'demo.mark-as-shipped','demo.mark-as-delivered','demo.cancel-order','demo.refund-order','demo.replay-events',
'demo.rewind-to','storage.local','storage.local.upload',);
        registerArgumentsSet('views', 
'dashboard','welcome','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line',
